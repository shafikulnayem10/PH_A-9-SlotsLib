...
export function Banner() {
  return (
    <div className="relative bg-white overflow-hidden">
      ...
      <div className="absolute top-0 right-0 -z-10 w-[50%] h-[600px] bg-gradient-to-b from-orange-50/50 to-transparent rounded-bl-[120px] hidden md:block" />
      <div className="absolute -top-40 -left-40 -z-10 w-96 h-96 bg-orange-100/30 rounded-full blur-3xl" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="pt-8 grid grid-cols-3 gap-4 border-t border-slate-100 max-w-md mx-auto lg:mx-0">
              <div>
                <p className="text-2xl md:text-3xl font-extrabold text-slate-900">10+</p>
                <p className="text-xs font-semibold text-slate-500 uppercase mt-0.5">Venues</p>
              </div>
              
              <div>
                <p className="text-2xl md:text-3xl font-extrabold text-slate-900">3k+</p>
                <p className="text-xs font-semibold text-slate-500 uppercase mt-0.5">Bookings</p>
              </div>
              
              <div>
                
                <div className="flex items-center justify-center lg:justify-start gap-1">
                  <p className="text-2xl md:text-3xl font-extrabold text-slate-900">4.9</p>
                  <Star className="w-5 h-5 text-amber-400 fill-current" />
                </div>
                <p className="text-xs font-semibold text-slate-500 uppercase mt-0.5">Rating</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative hidden md:block">
            <div className="relative mx-auto w-full max-w-[440px] aspect-[4/5] rounded-[32px] overflow-hidden shadow-2xl border-4 border-white ring-1 ring-slate-100 transform lg:rotate-2 hover:rotate-0 transition-transform duration-500">
